...
image_topic = '/camera/color/image_raw'  # Change this to your actual image topic
rospy.Subscriber(image_topic, Image, image_callback)

# Initialize the video writer
fourcc = cv2.VideoWriter_fourcc(*'mp4v')
out = cv2.VideoWriter(output_file, fourcc, frame_rate, (640, 480))  # Adjust the resolution as needed
